    ...
    <body>
        ...
        <table>
            <tr>
                ...
                <th>Nombre d'oni total</th>
                <th>HTML brut</th><th>Dump textuel</th>
                <th>Contextes</th><th>Concordancier</th>
            </tr>
EOF

mkdir -p aspirations dumps-text concordances contextes
...
while read -r line; do
    ...
    if [ "$CODE" -eq 200 ]; then
        ...
        {
            echo "<html><head><meta charset='UTF-8'><title>Aspirations</title></head><body><pre>"
    ...
    NB_TOTAL=$((NB_KANJI + NB_HIRA + NB_ROMA))
